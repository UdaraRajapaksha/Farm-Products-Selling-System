...
<div class="container">
     ...
     <span > <img class="img-responsive" style="max-height: 20vh;border-radius: 10px" src="data:image;base64,{{$custo->imag}}" alt="image"></span>
     </div>
     <div class="col-md-8">
     <span > <h1 style="font-family:Lucida Console;  font-size: 350%;font-weight: bold;color:#009900 ">{{$custo->supname}}</h1></span>
     ...
     @endforeach
       ...
       <div class="col-md-4">
          <div class="well" style="background-color: #e6f2ff" >
         <div class="row" >
       ...
       <span > <h4 style="font-family:Lucida Console;">{{$custo->phonNo}}</h4></span>
